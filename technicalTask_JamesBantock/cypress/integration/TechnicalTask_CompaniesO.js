...
describe('Technical Task for ReachPLC - O companies', () => {
  ...
  beforeEach(() => {
    ...
    cy.get('.browse').contains('O').click()
  })
  it('Business Details for Octapharma Limited', () => {

    //click on 1st Company.
    cy.get('.row').contains('Octapharma Limited').click()
    ...
    .each(function($detail, index, $details){ //Function
      cy.wrap($detail).within(function(){
        ...
        cy.get('.col-md-3').screenshot('Octapharma Limited')
        ...
        cy.writeFile('./cypress/CompanyDetails/Octapharma Limited.json', $detail.text().trim())
  ...
  it('Business Details for Orexigen Therapeutics Ireland Limited', () => {
    ...
    cy.get('.row').contains('Orexigen Therapeutics Ireland Limited').click()
    ...
    .each(function($detail, index, $details){ //Function
      cy.wrap($detail).within(function(){
        ...
        //Get screenshot of Company Logo
        cy.get('.col-md-3').screenshot('Orexigen Therapeutics Ireland Limited')
        ...
        cy.log($detail.text().trim())
        cy.writeFile('./cypress/CompanyDetails/Orexigen Therapeutics Ireland Limited.json', $detail.text().trim())

      })
    })
  })

    it('Business Details for Otsuka Pharmaceuticals (UK) Ltd', () => {

      //click on last Company.
      cy.get('.row').contains('Otsuka Pharmaceuticals (UK) Ltd').click()
      ...
      .each(function($detail, index, $details){ //Function
        cy.wrap($detail).within(function(){
          ...
          //Get screenshot of Company Logo
          cy.get('.col-md-3').screenshot('Otsuka Pharmaceuticals (UK) Ltd')
          ...
          cy.log($detail.text().trim())
          cy.writeFile('./cypress/CompanyDetails/Otsuka Pharmaceuticals (UK) Ltd.json', $detail.text().trim())
