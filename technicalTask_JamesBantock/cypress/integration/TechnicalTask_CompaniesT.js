...
describe('Technical Task for ReachPLC - T companies', () => {
  ...
  beforeEach(() => {
    ...
    cy.get('.browse').contains('T').click()
  })
  it('Business Details for Takeda UK Ltd', () => {

    //click on 1st Company.
    cy.get('.row').contains('Takeda UK Ltd').click()
    ...
    .each(function($detail, index, $details){ //Function
      cy.wrap($detail).within(function(){
        ...
        cy.get('.col-md-3').screenshot('Takeda UK Ltd')
        ...
        cy.writeFile('./cypress/CompanyDetails/Takeda UK Ltd.json', $detail.text().trim())

      })
    })
  })

  it('Business Details for Ten Pharma (a subsidiary of BCM Specials Ltd)', () => {

    //click on 3rd Company.
    cy.get('.row').contains('Ten Pharma (a subsidiary of BCM Specials Ltd)').click()
    ...
    .each(function($detail, index, $details){ //Function
      cy.wrap($detail).within(function(){
        ...
        //Get screenshot of Company Logo
        cy.get('.col-md-3').screenshot('Ten Pharma (a subsidiary of BCM Specials Ltd)')
        ...
        cy.log($detail.text().trim())
        cy.writeFile('./cypress/CompanyDetails/Ten Pharma (a subsidiary of BCM Specials Ltd).json', $detail.text().trim())

      })
    })
  })

    it('Business Details for Typharm Limited', () => {

      //click on last Company.
      cy.get('.row').contains('Typharm Limited').click()
      ...
      .each(function($detail, index, $details){ //Function
        cy.wrap($detail).within(function(){
          ...
          //Get screenshot of Company Logo
          cy.get('.col-md-3').screenshot('Typharm Limited')
          ...
          cy.log($detail.text().trim())
          cy.writeFile('./cypress/CompanyDetails/Typharm Limited.json', $detail.text().trim())
