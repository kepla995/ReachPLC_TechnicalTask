...
describe('Technical Task for ReachPLC - V companies', () => {
  ...
  beforeEach(() => {
    ...
    cy.get('.browse').contains('V').click()
  })
  it('Business Details for Valneva UK Limited', () => {

    //click on 1st Company.
    cy.get('.row').contains('Valneva UK Limited').click()
    ...
    .each(function($detail, index, $details){ //Function
      cy.wrap($detail).within(function(){
        ...
        cy.get('.col-md-3').screenshot('Valneva UK Limited')
        ...
        cy.writeFile('./cypress/CompanyDetails/Valneva UK Limited.json', $detail.text().trim())

      })
    })
  })

  it('Business Details for Vertex Pharmaceuticals (Europe) Limited', () => {

    //click on 3rd Company.
    cy.get('.row').contains('Vertex Pharmaceuticals (Europe) Limited').click()
    ...
    .each(function($detail, index, $details){ //Function
      cy.wrap($detail).within(function(){
        ...
        //Get screenshot of Company Logo
        cy.get('.col-md-3').screenshot('Vertex Pharmaceuticals (Europe) Limited')
        ...
        cy.log($detail.text().trim())
        cy.writeFile('./cypress/CompanyDetails/Vertex Pharmaceuticals (Europe) Limited.json', $detail.text().trim())

      })
    })
  })

    it('Business Details for Vygoris Limited', () => {

      //click on last Company.
      cy.get('.row').contains('Vygoris Limited').click()
      ...
      .each(function($detail, index, $details){ //Function
        cy.wrap($detail).within(function(){
          ...
          //Get screenshot of Company Logo
          cy.get('.col-md-3').screenshot('Vygoris Limited')
          ...
          cy.log($detail.text().trim())
          cy.writeFile('./cypress/CompanyDetails/Vygoris Limited.json', $detail.text().trim())
